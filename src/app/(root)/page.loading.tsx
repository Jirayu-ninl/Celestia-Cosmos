    ...
    <AnimatePresence>
      {isLoaded ? (
        <motion.a
          ...
          className='Btn-white-40 Anim AnimOpacity-60 mx-auto mb-auto cursor-pointer uppercase hover:bg-primary hover:text-black hover:shadow-lg hover:shadow-primary'
